...
//###### Konfiguration
static const char SSID[] = "Nostromo";
static const char PASS[] = "/connect to the_hive!";
static const IPAddress BROKER(10, 0, 0, 95);
static const uint16_t PORT =  1883;
static const char CLIENTID[] = "VitoWifi";
static const char MQTTUSER[] = "vitowifi";
static const char MQTTPASS[] = "QiZXhqRX@Mr7Px#bAL!n";
...
void loop() {
  if (!bStopVito){
    ...
    if (updateVitoWiFi && mqttClient.connected()) {
      ...
      Serial.println("Trying to read all from VitoWiFi.");
      VitoWiFi.readAll();
    }
  }
